...
public class RetailSignInPage extends BaseSetup {
	...
	public RetailSignInPage() {
		...
		// this method aaccepts two parameters, first one is driver and
		// second is this keyword which referes to variable of this class in this case
		// we are rreferring to UI elements that will store in this class
	}
